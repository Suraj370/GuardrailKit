...
Distinct from :class:`~llm_redteam.domain.models.vulnerability.Vulnerability`,
which is a concrete probe target authored inside one
:class:`~llm_redteam.domain.models.campaign.Campaign` (an id, a
...
class VulnerabilityDefinition:
    ...
    registries (:data:`~llm_redteam.plugins.GENERATORS`,
    :data:`~llm_redteam.plugins.POLICIES`) — this module does
