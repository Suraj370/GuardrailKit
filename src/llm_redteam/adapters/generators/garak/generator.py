...
:class:`~llm_redteam.domain.ports.attack_generator.AttackGenerator`
exactly like :class:`~llm_redteam.adapters.generators.dummy_generator.DummyAttackGenerator`
