...
remain :class:`~llm_redteam_firewall.application.execution_engine.ExecutionEngine`'s
...
class RetryPolicy:
    ...
    today's actual behavior: :class:`~llm_redteam_firewall.application.execution_engine.ExecutionEngine`
...
class AttackBatch:
    ...
    the shape :class:`~llm_redteam_firewall.application.execution_engine.ExecutionEngine.run`
