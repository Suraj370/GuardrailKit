...
``[project.entry-points."llm_redteam_firewall.generators"]`` entry),
...
_ENTRY_POINT_NAMESPACE = "llm_redteam_firewall"
...
class Registry[T]:
    ...
    def discover_entry_points(self) -> None:
        ...
        Group name convention: ``llm_redteam_firewall.<category>``,
        e.g. ``llm_redteam_firewall.generators``. Idempotent and cheap
