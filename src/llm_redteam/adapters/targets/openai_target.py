...
:mod:`~llm_redteam.adapters.generators.garak.probe_registry`'s
lazy-import pattern — so importing ``llm_redteam.adapters``
...
class OpenAITarget(Target):
    ...
    :class:`~llm_redteam.domain.ports.target.Target` contract's
