...
Single responsibility: inspect one :class:`~llm_redteam_firewall.domain.models.attack.Attack`
and its :class:`~llm_redteam_firewall.domain.models.response.Response` and
return zero or more :class:`~llm_redteam_firewall.domain.models.finding.Finding`
...
:class:`~llm_redteam_firewall.domain.models.evaluation_result.EvaluationResult`
